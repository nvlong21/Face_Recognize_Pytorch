...
class LFW(data.Dataset):
    def __init__(self, root = conf['lfw_root'], file_list = conf.lfw_file_list, transform=None, loader=img_loader):
...
#     root = '/mnt/01D4A1D481139570/Dataset/Face/lfw_process/lfw-112X96'
#     file_list = '/mnt/01D4A1D481139570/Dataset/Face/lfw_process/pairs.txt'
